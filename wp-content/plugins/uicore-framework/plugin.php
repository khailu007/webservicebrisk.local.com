...
final class Core
{
    ...
    public function __construct()
    {
        ...
        if(self::is_rest()){
            ...
            add_action('init', [$this, 'init_plugin_data']);
        }
        // $this->init_plugin_data();
    ...
    function upgrader_process_complete( $upgrader_object, $options ) {
        if ( $options['action'] == 'update' && $options['type'] == 'plugin' && $options['plugins'][0] == 'uicore-framework/uicore-framework.php' ) {

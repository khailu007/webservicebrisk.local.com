...
class Element_Pack_Loader {
    ...
    public function enqueue_site_scripts() {
        ...
        $script_config = [
            ...
            'data_table' => [
                'language' => [
                    'lengthMenu' => sprintf(esc_html_x('%1s Entries', 'DataTable String', 'bdthemes-element-pack'), '_MENU_'),
                    'info' => sprintf(esc_html_x('%1s to %2s of %3s entries', 'DataTable String', 'bdthemes-element-pack'), '_START_', '_END_', '_TOTAL_'),
